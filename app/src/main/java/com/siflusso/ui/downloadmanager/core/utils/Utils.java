...
package com.siflusso.ui.downloadmanager.core.utils;
...
import com.siflusso.ui.downloadmanager.core.filter.DownloadFilter;
import com.siflusso.ui.downloadmanager.core.filter.DownloadFilterCollection;
...
import com.siflusso.ui.downloadmanager.core.sorting.DownloadSorting;
import com.siflusso.ui.downloadmanager.core.sorting.DownloadSortingComparator;
import com.siflusso.ui.downloadmanager.core.system.FileSystemFacade;
import com.siflusso.ui.downloadmanager.core.system.SafFileSystem;
...
import com.siflusso.ui.downloadmanager.receiver.BootReceiver;
import com.siflusso.ui.downloadmanager.ui.main.DownloadItem;
import com.siflusso.ui.downloadmanager.ui.main.drawer.DrawerGroup;
import com.siflusso.ui.downloadmanager.ui.main.drawer.DrawerGroupItem;
import java.io.File;
...
import static com.siflusso.ui.downloadmanager.core.utils.MimeTypeUtils.DEFAULT_MIME_TYPE;
import static com.siflusso.ui.downloadmanager.core.utils.MimeTypeUtils.MIME_TYPE_DELIMITER;
...
public class Utils {
    ...
    public static void enableBrowserLauncherIcon(@NonNull Context context, boolean enable) {
        ...
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.siflusso.ui.downloadmanager.ui.browser.BrowserIcon"),
    ...
    public static void disableBrowserFromSystem(@NonNull Context context, boolean disable) {
        ...
        int flag = (disable ?
                ...
                PackageManager.COMPONENT_ENABLED_STATE_ENABLED);
        pm.setComponentEnabledSetting(
                new ComponentName(context, "com.siflusso.ui.downloadmanager.ui.browser.Browser"),
                flag, PackageManager.DONT_KILL_APP);
    }
